-- Update admin_get_jobs_with_metrics to include location, city, state, country
-- Also ensure primary admin seed exists
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM auth.users WHERE email = 'adailtong@gmail.com') THEN
    ...
    VALUES (new_user_id, 'adailtong@gmail.com', 'Admin', true, 'admin')
    ON CONFLICT (id) DO UPDATE SET is_admin = true, role = 'admin';
  ELSE
    -- Just ensure it's admin
