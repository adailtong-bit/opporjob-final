...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (engineId === '124578ab1a147cdc8baf7376968c4f1f') {
      const randomBatchId = crypto.randomUUID().split('-')[0]
      mockItems = [
        {
          id: `buscador_item_${randomBatchId}_1`,
          title: 'Desenvolvimento de Site Institucional',
          description:
            'Criação de site responsivo e otimizado para SEO com 5 páginas.',
          price: 1500,
          location: 'São Paulo, SP',
          category: 'Tecnologia',
          photos: ['https://img.usecurling.com/p/600/600?q=website&color=blue'],
        },
        {
          id: `buscador_item_${randomBatchId}_2`,
          title: 'Consultoria em Marketing Digital',
          description:
            'Análise de presença online e plano de ação para redes sociais.',
          price: 800,
          location: 'Rio de Janeiro, RJ',
          category: 'Marketing',
          photos: [
            'https://img.usecurling.com/p/600/600?q=marketing&color=purple',
          ],
        },
        {
          id: `buscador_item_${randomBatchId}_3`,
          title: 'Aulas Particulares de Inglês',
          description:
            'Aulas focadas em conversação e negócios, online ou presencial.',
          price: 80,
          location: 'Curitiba, RJ',
          category: 'Educação',
          photos: ['https://img.usecurling.com/p/600/600?q=english&color=red'],
        },
        {
          id: `buscador_item_${randomBatchId}_4`,
          title: 'Serviço de Frete e Mudança',
          description: 'Caminhão baú para mudanças locais e intermunicipais.',
          price: 300,
          location: 'Belo Horizonte, PR',
          category: 'Serviços',
          photos: [
            'https://img.usecurling.com/p/600/600?q=moving&color=yellow',
          ],
        },
        {
          id: `buscador_item_${randomBatchId}_5`,
          title: 'Manutenção de Ar Condicionado',
          description: 'Limpeza, higienização e recarga de gás para splits.',
          price: 150,
          location: 'Brasília, MG',
          category: 'Manutenção',
          photos: [
            'https://img.usecurling.com/p/600/600?q=air-conditioner&color=cyan',
          ],
        },
      ]
    } else {
      mockItems = [
        ...
        },
        {
          ...
          description:
            'Reliable moving services. Two men and a large truck. We handle everything with care.',
          price: 80,
          location: 'Miami, FL',
          category: 'Services',
        ...
        },
        {
          ...
          description:
            'Space Gray, 16GB RAM, 1TB SSD. Comes with original charger and box.',
          price: 1200,
        ...
        },
        {
          ...
          description:
            'Deep cleaning, regular maintenance, move-in/move-out cleaning. Eco-friendly products.',
          price: 150,
          location: 'Seattle, WA',
          category: 'Services',
          photos: [
            'https://img.usecurling.com/p/600/600?q=cleaning&color=cyan',
          ],
        },
        {
          id: 'apify_item_008',
          ...
          description:
            'Panel upgrades, wiring, lighting installation, and troubleshooting.',
          price: 90,
          location: 'Denver, CO',
          category: 'Services',
          photos: [
            'https://img.usecurling.com/p/600/600?q=electrician&color=orange',
          ],
        },
        {
          id: 'apify_item_009',
          ...
          description:
            'Used for one season. Excellent condition. 29er wheels, medium frame.',
          price: 350,
        ...
        },
        {
          ...
          description:
            'Weddings, corporate events, and portraits. High-quality edits included.',
          price: 500,
          location: 'Atlanta, GA',
          category: 'Services',
