    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrencyValue(totalBalance, 'USD')}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrencyValue(totalSpent, 'USD')}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrencyValue(pendingAmount, 'USD')}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
                    ...
                    <BarChart data={cashFlowData.slice(0, 4)}>
                      ...
                      <Tooltip
                        content={
                          <ChartTooltipContent
                            formatter={(value) =>
                              formatCurrencyValue(Number(value), 'USD')
                            }
                          />
                        }
                      />
                    ...
                    .map((tx) => (
                      <TableRow key={tx.id}>
                        ...
                        <TableCell className="font-semibold text-green-600">
                          {formatCurrencyValue(tx.amount, tx.currency || 'USD')}
                        </TableCell>
                        <TableCell>
                          {tx.status === 'completed' && (
                            <Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-100">
